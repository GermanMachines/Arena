...
public class ProductSrvc {
    ...
    public void exportTable() throws SQLException, FileNotFoundException {
        try {
            ...
            PdfWriter.getInstance(my_pdf_report, new FileOutputStream("C:\\Users\\LENOVO\\Documents\\github\\Arena\\src\\edu\\arena\\uploads\\reports\\products/report" + random_id + ".pdf"));
