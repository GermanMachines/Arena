...
User u =  new User();
  ...
  tfIdEquipe.setText(String.valueOf(u.getId_equipe()));
         try {
    ...
    private void ParticiperTournois(ActionEvent event){
        ...
        int Equipeid=getTxtIdEquipe();
         ...
         int nbp = cer.VerifNombreParticipation(idtournois);
           int nbparticipants = tournois.getNbrParticipants();
        ...
        System.out.println(nbparticipants);
          ...
          else if(nbparticipants>nbp && res==0){
